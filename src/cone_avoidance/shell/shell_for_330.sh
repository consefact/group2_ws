...
tmux send-keys -t ros_session:1.1 'sleep 7; source ~/group2_save_work/first_task_ws/devel/setup.zsh; roslaunch collision_avoidance collision_avoidance.launch' C-m
